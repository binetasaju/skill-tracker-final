// This file now handles API calls for login and registration
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (regForm) {
        // 1. Populate the departments dropdown first
        loadDepartments();
        ...
        regForm.addEventListener('submit', async (e) => {
            ...
            const department_id = regForm.department_id.value; // This is now an ID
...
async function loadDepartments() {
    ...
    try {
        ...
        selectEl.innerHTML = '<option value="">Error loading departments</a.option>';
    }
}